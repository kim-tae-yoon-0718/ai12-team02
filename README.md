...
| 항목 | 결과 |
|---|---:|
| 최신 개발용 전체 점수 | **0.9400** (47/50) |
| 선별형 / 추출형 / QA형 | **1.0000 / 1.0000 / 0.7000** |
| 고정 조건 모델 실험 | **0.7357 → 0.8000** |
| 3단계 비용 절감 | **50.96%** |
| 3단계 실행 시간 절감 | **52.98%** |
...
<details>
<summary><strong>전체 실험 흐름 보기</strong></summary>

| 단계 | 전체 점수 | 핵심 발견 |
|---|---:|---|
| 베이스라인 | 0.7357 | 추출형이 가장 낮았지만 검색만의 문제는 아니었음 |
| 1단계 | 0.7400 | 질문을 구조화했으나 최초 오해는 남음 |
| 2단계 | 통합 점수 미확정 | 결과를 보고 도구를 다시 쓰는 루프 구축 |
| 2단계 1차 | 0.7400 | 두 해석 비교로 초기 오해를 방어 |
| 2단계 1·2차 | 0.7300 | 선별형 1.0000에도 최종 생성에서 손실 발생 |
| 2단계 1·2·3차 | 0.8000 | 추출값 직접 조립으로 누락·추가 억제 |
| 3단계 | 0.8000 | 품질 유지, 비용·시간 약 절반 절감 |
